...
Below example shows how to use 'dproxyme' function to estimate measurement (stochastic) matrices of proxy variables and type probabilities. The code first simulates fake data using a data generating process provided below and then estimates the parameters using 'dproxyme' function.
